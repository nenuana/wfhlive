...
@WebServlet(
        urlPatterns = {"/editInregistrari3"}
)
public class EditInregistrari3 extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public EditInregistrari3() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            if (System.getProperty("com.google.appengine.runtime.version").startsWith("Google App Engine/")) {
                ...
                } catch (ClassNotFoundException var237) {
                    throw new ServletException("Error loading Google JDBC Driver", var237);
                }
            } else {
            ...
            } catch (SQLException var236) {
                var236.printStackTrace();
            ...
            try {
                ...
                it2 unitsearch = DBUtilis.finddepandunit(conn, emails);
                String unitatesearch = unitsearch.getUnit();

                try {
                    list8 = DBUtilis.queryemail(conn, emails);
                    System.out.println("s-a facut query toti utilizatorii: ");
                    System.out.println(list8);
                } catch (SQLException var234) {
                    var234.printStackTrace();
                    errorString = var234.getMessage();
                }
                ...
                if (errorString != null && list8 == null) {
                    ...
                    request.setAttribute("unitate", unitatesearch);
                ...
                throw new RuntimeException(var235);
            }
        }
    }
