...
@WebServlet(
        urlPatterns = {"/editInregistrari2"}
)
public class EditInregistrari2 extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public EditInregistrari2() {
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!path.startsWith("/favicon.ico")) {
            ...
            if (System.getProperty("com.google.appengine.runtime.version").startsWith("Google App Engine/")) {
                ...
                } catch (ClassNotFoundException var235) {
                    throw new ServletException("Error loading Google JDBC Driver", var235);
                }
            } else {
            ...
            try {
                ...
                try {
                    list8 = DBUtilis.querysearch(conn, units);
                ...
                if (errorString != null && list8 == null) {
                    ...
                    } catch (SQLException var211) {
                        var211.printStackTrace();
                        errorString = var211.getMessage();
                    }
                    ...
                    request.setAttribute("unitate", units);
                ...
                throw new RuntimeException(var233);
            }
        }
    }
